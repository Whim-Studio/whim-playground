...
/** [SKELETON STUB] Replace with the real Take Up the Sword screen. Keep the (Game) ctor and name(). */
public class CharCreateScreen extends Screen {
    public CharCreateScreen(Game game) { super(game); }
    ...
    protected void paintComponent(Graphics g0) {
        ...
        g.drawString("Take Up the Sword", 60, 120);
