...
/** [SKELETON STUB] Replace with the real Character screen. Keep the (Game) ctor and name(). */
public class CharacterScreen extends Screen {
    public CharacterScreen(Game game) { super(game); }
