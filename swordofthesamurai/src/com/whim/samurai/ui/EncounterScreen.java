...
/** [SKELETON STUB] Replace with the real Encounter screen. Keep the (Game) ctor and name(). */
public class EncounterScreen extends Screen {
    public EncounterScreen(Game game) { super(game); }
