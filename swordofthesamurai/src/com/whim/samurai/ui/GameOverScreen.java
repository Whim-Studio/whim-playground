...
/** [SKELETON STUB] Replace with the real The Dynasty Ends screen. Keep the (Game) ctor and name(). */
public class GameOverScreen extends Screen {
    public GameOverScreen(Game game) { super(game); }
    ...
    protected void paintComponent(Graphics g0) {
        ...
        g.drawString("The Dynasty Ends", 60, 120);
