...
/** [SKELETON STUB] Replace with the real The Provinces screen. Keep the (Game) ctor and name(). */
public class MapScreen extends Screen {
    public MapScreen(Game game) { super(game); }
    ...
    protected void paintComponent(Graphics g0) {
        ...
        g.drawString("The Provinces", 60, 120);
